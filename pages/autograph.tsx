...
const Autograph = (): JSX.Element => {
  ...
  return (
    <Layout>
      ...
      {(!wallet && !transId) && (
        <>
          <div className='container my-12 py-12 mx-auto px-6'>
            <section className='mb-20'>
              <div className='text-center'>
                <h3 className='mb-12 text-gray-800 text-2xl font-semibold'>Autograph</h3>
              </div>
              <div className='grid md:grid-cols-3 gap-4 flex justify-center'>
                <div className='mb-6 lg:mb-0'>
                  <div className='block rounded-lg shadow-lg text-white relative overflow-hidden bg-no-repeat bg-cover' style={{ backgroundPosition: '50%' }}>
                    ...
                    <div className='absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed' style={{ background: 'linear-gradient(to bottom right, rgba(247, 97, 161, 0.85), rgba(140, 27, 171, 0.85))' }}>
